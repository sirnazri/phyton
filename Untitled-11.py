...
def main():
    """Start a traditionalgame."""
    print("Guess the traditional game!")
    ...
    while trial<max_trials:
        guess = str(input("What traditional game are we thinking of? "))
        ...
        if x == guess:
            ...
            max_trials -= 1
        if max_trials == 0:
            print(f"out of attempts. The gamw is actually {x}.".format(guess))
